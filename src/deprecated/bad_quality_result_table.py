...
$ python bad_quality_result_table.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled T -dose_response exponential -seeds_per_t 1 -type original
$ python bad_quality_result_table.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled T -dose_response exponential -seeds_per_t 3 -type original
...
def get_infile_name_and_name_list(args, graph_name):
    ...
    if args.type == "expectedT" and graph_name in ["G_Carilion", "G_UVA", "G_UVA_v2"]:
        P1_infile_name_list = [
...
if __name__ == "__main__":
    ...
    # -------------------------------------------
    path = "../tables/GT_bad/{}/seedspert{}_ntseeds{}_ntforeval{}/".format(graph_name, seeds_per_t, n_t_seeds, n_t_for_eval)
    ...
    # avg_of_min_hop_list = compute_avg_of_min_hop_list(GT_S_list_of_tuples, L_B_random_list_of_tuples, cult_list_of_tuples, \
            # reachability_list_of_tuples, LOS_list_of_tuples, algo_P123_list_of_tuples)
