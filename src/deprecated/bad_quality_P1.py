...
$ python bad_quality_P1.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled True -seeds_per_t 1 -flag_lazy T
$ python bad_quality_P1.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled True -seeds_per_t 3 -flag_lazy T

$ python bad_quality_P1.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled True -seeds_per_t 1
$ python bad_quality_P1.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled True -seeds_per_t 3
"""
...
if __name__ == "__main__":
    ...
    cardinality_constraint_list = [k for k in range(cardinality_constraint_min, cardinality_constraint_max+1)]
    ...
    i_P1_greedy = np.nanargmax(np.array(L_P1_greedy_MCC))
