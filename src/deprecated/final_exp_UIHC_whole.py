...
NOTE: run it on seeds_per_t = 1 only.
...
$ python final_exp_P3.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -seeds_per_t 1
"""
...
if __name__ == "__main__":
    ...
    if args.flag_expected_simulation:
        ...
        simul.set_n_t_for_eval(args.n_t_for_eval)
    else:
    ...
    for penalty_array_idx, array_of_penalty_on_f in enumerate(L_penalty_array):
        ...
        if args.flag_expected_simulation:
            ...
            GR_seeds_array, GR_n_S, GR_n_S_correct, GR_loss_1, GR_loss_total, \
                GR_list_of_P_hit, GR_list_of_N_hit, \
                GR_TP, GR_TN, GR_FP, GR_FN, GR_F1, GR_MCC = \
                    evaluate_solution_seeds(simul, list_of_people_idx_arrays, seeds_array, GR_seeds_array, obs_state, list_of_sets_of_P, list_of_sets_of_N, args.n_t_for_eval)
    ...
    i_GR = np.argmax(np.array(L_GR_MCC))
