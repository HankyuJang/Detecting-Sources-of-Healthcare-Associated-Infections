...
$ python final_exp_result_running_time.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled T -dose_response exponential -seeds_per_t 3
...
if __name__ == "__main__":
    ...
    P2_ISCK_greedy_infile_name_list = [
            "{}P2_ISCK_greedy_evalution_lazyF_expectedF.pickle".format(txt_dose_response),
            "{}P2_ISCK_greedy_evalution_lazyT_expectedF.pickle".format(txt_dose_response),
            "{}P2_ISCK_greedy_evalution_lazyT_expectedT.pickle".format(txt_dose_response),
            ]
    P2_ISCK_greedy_name_list = [
            "{}P2_ISCK_Greedy".format(txt_dose_response),
            "{}P2_ISCK_LazyGreedy".format(txt_dose_response),
            "{}P2_ISCK_E_LazyGreedy".format(txt_dose_response),
            ]
    ...
    for infile in P1_infile_name_list:
        ...
        df_P1_greedy = load_Px_results_for_runtime(P1_greedy_evaluation_dict)
        list_of_df.append(df_P1_greedy)
        df_best_MCC_P1_greedy = load_Px_results(P1_greedy_evaluation_dict)
        list_of_df_best_MCC.append(df_best_MCC_P1_greedy)

    df_P1_greedy_result = concat_result_dataframes(P1_name_list, list_of_df)
    print(df_P1_greedy_result[['n_S', 'n_S_correct', 'TP', 'TN', 'FP', 'FN', 'F1', 'MCC', 'Time(s)']].round(3))
    df_best_MCC_P1_greedy_result = concat_result_dataframes(P1_name_list, list_of_df_best_MCC)
    print(df_best_MCC_P1_greedy_result[['n_S', 'n_S_correct', 'TP', 'TN', 'FP', 'FN', 'F1', 'MCC', 'Time(s)']].round(3))

    list_of_df = []
    list_of_df_best_MCC = []

    print("P2 ISCK greedy...")
    for infile in P2_ISCK_greedy_infile_name_list:
        with open(path + infile, 'rb') as handle:
    ...
    df_P2_ISCK_greedy_result = concat_result_dataframes(P2_ISCK_greedy_name_list, list_of_df)
    print(df_P2_ISCK_greedy_result[['n_S', 'n_S_correct', 'TP', 'TN', 'FP', 'FN', 'F1', 'MCC', 'Time(s)']].round(3))
    df_best_MCC_P2_ISCK_greedy_result = concat_result_dataframes(P2_ISCK_greedy_name_list, list_of_df_best_MCC)
    print(df_best_MCC_P2_ISCK_greedy_result[['n_S', 'n_S_correct', 'TP', 'TN', 'FP', 'FN', 'F1', 'MCC', 'Time(s)']].round(3))
    ...
    label_list_1 = ["Original", "Lazy", "Expected + Lazy"]
    label_list_2 = ["Original", "Expected"]

    color_list_1 = ["blue", "orange", "green"]
    color_list_2 = ["blue", "green"]

    ylabel = "Running time in seconds"

    print("P1 ...")
    outfile = "P1_greedy_runtime.png"
    title = "Problem1 greedy - Run time"
    plot_bar(df_P1_greedy_result["Time(s)"].values, label_list_1, color_list_1, ylabel, title, outpath, outfile)
    
    print("P2 ISCK greedy...")
    outfile = "P2_ISCK_greedy_runtime.png"
    title = "Problem2 ISCK (greedy) - Run time"
    plot_bar(df_P2_ISCK_greedy_result["Time(s)"].values, label_list_1, color_list_1, ylabel, title, outpath, outfile)

    print("P2 ISCK multiplicative_update...")
    outfile = "P2_ISCK_multiplicative update_runtime.png"
    title = "Problem2 ISCK (multiplicative update) - Run time"
    plot_bar(df_P2_ISCK_MU_result["Time(s)"].values, label_list_1, color_list_1, ylabel, title, outpath, outfile)

    print("P3 ...")
    outfile = "P3_greedy_ratio_runtime.png"
    title = "Problem1 greedy ratio - Run time"
    plot_bar(df_P3_greedy_ratio_result["Time(s)"].values, label_list_2, color_list_2, ylabel, title, outpath, outfile)
    ...
    print("P1 ...")
    outfile = "P1_greedy_MCC.png"
    title = "Problem1 greedy - MCC score"
    plot_bar(df_P1_greedy_result["MCC"].values, label_list_1, color_list_1, ylabel, title, outpath, outfile)
    
    print("P2 ISCK greedy...")
    outfile = "P2_ISCK_greedy_MCC.png"
    title = "Problem2 ISCK (greedy) - MCC score"
    plot_bar(df_P2_ISCK_greedy_result["MCC"].values, label_list_1, color_list_1, ylabel, title, outpath, outfile)

    print("P2 ISCK multiplicative_update...")
    outfile = "P2_ISCK_multiplicative update_MCC.png"
    title = "Problem2 ISCK (multiplicative update) - MCC score"
    plot_bar(df_P2_ISCK_MU_result["MCC"].values, label_list_1, color_list_1, ylabel, title, outpath, outfile)

    print("P3 ...")
    outfile = "P3_greedy_ratio_MCC.png"
    title = "Problem1 greedy ratio - MCC score"
    plot_bar(df_P3_greedy_ratio_result["MCC"].values, label_list_2, color_list_2, ylabel, title, outpath, outfile)
