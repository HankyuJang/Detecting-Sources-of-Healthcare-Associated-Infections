...
$ python case_study_P2.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled T -flag_lazy T -flag_expected_simulation T -compute_pi greedy
$ python case_study_P2.py -name UIHC_HCP_patient_room_withinHCPxPx -year 2011 -sampled T -flag_lazy T -flag_expected_simulation T -compute_pi multiplicative_update
"""
...
if __name__ == "__main__":
    ...
    i_best_ISCK = np.argmax(np.array(LoL_ISCK_MCC))
